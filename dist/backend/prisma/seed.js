    ...
    const properties = [
        {
            ...
            auctionStart: (0, date_fns_1.subHours)(new Date(), 10),
            auctionEnd: (0, date_fns_1.addHours)(new Date(), 6),
        ...
        },
        {
            ...
            auctionStart: (0, date_fns_1.subHours)(new Date(), 7),
            auctionEnd: (0, date_fns_1.addHours)(new Date(), 8),
            status: client_1.AuctionStatus.ACTIVE,
            latitude: 25.1972,
            longitude: 55.2744,
        },
        {
            ...
            auctionStart: (0, date_fns_1.subHours)(new Date(), 4),
            auctionEnd: (0, date_fns_1.addHours)(new Date(), 4),
            status: client_1.AuctionStatus.ACTIVE,
            latitude: 25.3374,
            longitude: 55.3773,
        },
        {
            ...
            minimumIncrement: 10000,
            auctionStart: (0, date_fns_1.addHours)(new Date(), 12),
            auctionEnd: (0, date_fns_1.addHours)(new Date(), 36),
